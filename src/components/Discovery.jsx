...
const Discovery = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-black text-white overflow-hidden">
      ...
      <div className="shrink-0 z-50 p-4 bg-black/80 backdrop-blur-2xl border-b border-white/5">
      ...
      <div className="flex-1 overflow-y-auto pb-28 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-zinc-800 [&::-webkit-scrollbar-thumb]:rounded-full">
        {loading ? (
